  ...
  background-size: cover;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="container mt-4 " id="cproduct">
        <div class="container">
        <h2 align="center" > <?php.$HawkName.;?> </h2> <br>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"       aria-hidden="true">
          ...
          <div align="center" >
              ...
              class="btn btn-outline-dark my-2 my-sm-0 btn-lg" type="submit" name="SearchRequest" >Contact Info </button> <br><br>
         </div>
...
<h1 align="center" >Available Product List</h1>
        <br><br>
            <table class="table" style="font-size: 20px; background-image: url('image/table.jpg'); background-repeat: no-repeat;background-attachment: fixed;
  background-size: cover;">
                <tr align="center" >
                    <th>
                        Name of the Product
